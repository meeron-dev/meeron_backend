...
insert into workspace_user(workspace_user_id, user_id, workspace_id, team_id, created_date, last_modified_date, is_workspace_admin, nickname, profile_image_url, position)
values(2, 2, 1, 2, current_timestamp, current_timestamp, true, '네코', '', 'Planner');
insert into workspace_user(workspace_user_id, user_id, workspace_id, team_id, created_date, last_modified_date, is_workspace_admin, nickname, profile_image_url, position)
values(3, 3, 1, 3, current_timestamp, current_timestamp, false, '제로', '', 'Android');
insert into workspace_user(workspace_user_id, user_id, workspace_id, team_id, created_date, last_modified_date, is_workspace_admin, nickname, profile_image_url, position)
...
insert into meeting(meeting_id, workspace_id, team_id, name, purpose, start_date, start_time, end_time, place, created_date, last_modified_date)
values(2, 1, 2, '1주차 기획 청사진 공지', '공지사항', '2022-02-20', '21:00', '23:00', '구글 밋', current_timestamp, current_timestamp);
insert into attendee(attendee_id, meeting_id, workspace_user_id, attend_status, created_date, last_modified_date, is_meeting_admin)
...
insert into meeting(meeting_id, workspace_id, team_id, name, purpose, start_date, start_time, end_time, place, created_date, last_modified_date)
values(3, 1, 2, '2주차 기획 청사진 공지', '공지사항', '2022-02-28', '22:00', '23:00', '구글 밋', current_timestamp, current_timestamp);
insert into attendee(attendee_id, meeting_id, workspace_user_id, attend_status, created_date, last_modified_date, is_meeting_admin)
...
insert into meeting(meeting_id, workspace_id, team_id, name, purpose, start_date, start_time, end_time, place, created_date, last_modified_date)
values(4, 1, 3, '앱 데이터베이스 설계', '논의', '2022-03-01', '22:00', '00:00', '구글 밋', current_timestamp, current_timestamp);
insert into attendee(attendee_id, meeting_id, workspace_user_id, attend_status, created_date, last_modified_date, is_meeting_admin)
...
insert into meeting(meeting_id, workspace_id, team_id, name, purpose, start_date, start_time, end_time, place, created_date, last_modified_date)
values(5, 1, 3, '테스트 회의', '테스트', '2022-03-05', '22:00', '23:00', null, current_timestamp, current_timestamp);
insert into attendee(attendee_id, meeting_id, workspace_user_id, attend_status, created_date, last_modified_date, is_meeting_admin)
