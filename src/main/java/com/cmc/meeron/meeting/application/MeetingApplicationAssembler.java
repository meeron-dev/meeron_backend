...
class MeetingApplicationAssembler {
    ...
    static List<MonthMeetingsCountResponseDto> toMonthMeetingsCountResponseDtoSortByMonth(List<MonthMeetingsCountDto> monthMeetingsCountDtos) {
        List<MonthMeetingsCountResponseDto> monthMeetingsCountResponseDtos = monthMeetingsCountDtos.stream()
