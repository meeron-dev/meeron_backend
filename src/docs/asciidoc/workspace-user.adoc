...
== '워크스페이스 유저' 의 유저(회원 정보) 조회
=== [GET] /api/workspace-users/{id}/user
include::{snippets}/workspace-user-rest-controller-test/get_user_success/http-request.adoc[]
include::{snippets}/workspace-user-rest-controller-test/get_user_success/request-headers.adoc[]
include::{snippets}/workspace-user-rest-controller-test/get_user_success/path-parameters.adoc[]
include::{snippets}/workspace-user-rest-controller-test/get_user_success/http-response.adoc[]
include::{snippets}/workspace-user-rest-controller-test/get_user_success/response-fields.adoc[]

==== 1701
include::{snippets}/workspace-user-rest-controller-test/get_user_fail_not_found/http-request.adoc[]
include::{snippets}/workspace-user-rest-controller-test/get_user_fail_not_found/http-response.adoc[]
