...
include::{snippets}/meeting-query-rest-controller-test/get_workspace_meeting_days_fail_require_year-month/http-request.adoc[]
include::{snippets}/meeting-query-rest-controller-test/get_workspace_meeting_days_fail_require_year-month/http-response.adoc[]
...
include::{snippets}/meeting-query-rest-controller-test/get_workspace_day_meetings_fail_require_local-date/http-request.adoc[]
include::{snippets}/meeting-query-rest-controller-test/get_workspace_day_meetings_fail_require_local-date/http-response.adoc[]
