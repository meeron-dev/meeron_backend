...
=== 제공하지 않는 provider일 경우
include::{snippets}/auth-rest-controller-test/login_fail_not_provider/http-request.adoc[]
include::{snippets}/auth-rest-controller-test/login_fail_not_provider/http-response.adoc[]
